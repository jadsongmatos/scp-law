...
Uso:
  python3 extract_positions.py src/assets/images/scp_entrance_*.png
  python3 extract_positions.py src/assets/images/scp_entrance_*.png --room entrance
  python3 extract_positions.py src/assets/images/*.png --all
  python3 extract_positions.py src/assets/images/scp_entrance_*.png --yolo-model yolov8x.pt
  python3 extract_positions.py src/assets/images/scp_entrance_*.png --dry-run
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", "-o",
        default="extracted_positions.json",
        metavar="FILE",
        help="Arquivo JSON de saída (padrão: extracted_positions.json)",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
